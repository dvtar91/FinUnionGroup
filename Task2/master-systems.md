...
| 2 | **Счёт (Account)** | FU Core, RB Core | **Core Banking FinUnion** (главный OLTP‑хост) | Core Banking (унифицированный, мульти‑тенант) | *Current Account* | Счёта остаются в профильных банковских ядрах; FinUnion‑ядро будет драйвером миграции. |
| 3 | **Карта (Card)** | FU Cards, RB Cards | **Card Processing FinUnion** | Card Processing (унифицированный) | *Card Management* | Карты зависят от платёжной инфраструктуры, поэтому их мастер‑система – процессинговый сервис. |
| 4 | **Кредит (Loan)** | FU Loans, RB Loans | **Loan System FinUnion** | Loan System (унифицированный) | *Loan Management* | Кредитные договоры требуют строгой консолидированной расчётной логики. |
